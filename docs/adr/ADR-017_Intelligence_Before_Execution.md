...
- [x] Implement [SPEC-031](../specs/SPEC-031_Business_Signals_Capability.md) Active Business Signals (lifecycle + decay) / [ADR-018](ADR-018_Time_Matters.md) — v1; CI Signals stage still pending
