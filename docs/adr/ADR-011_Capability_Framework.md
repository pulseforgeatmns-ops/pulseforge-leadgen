...
- [x] Business Signals Active set ([SPEC-031](../specs/SPEC-031_Business_Signals_Capability.md) / [ADR-018](ADR-018_Time_Matters.md)) — v1 library; wire into Company Intelligence Signals stage when SPEC-030 lands
