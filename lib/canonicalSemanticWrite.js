...
// Closed union of SPEC-222 v1 types plus SPEC-250 OPERATOR_JUDGMENT. Registry artifacts
// remain the per-commit closed vocabulary; this set is the write-path allowlist.
const ENTITY_TYPES = new Set(['BUSINESS', 'OFFER', 'PROGRAM', 'CUSTOMER_PROFILE', 'PAIN', 'CAPABILITY', 'OUTCOME', 'OBJECTIVE', 'METRIC', 'OPERATOR_JUDGMENT']);
