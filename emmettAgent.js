...
// Warm substitution step used by main() when a prospect has clicked but has not
// yet received the warm follow-up. Falls back to the cleaning Day 4 step so
// the useWarm branch always has a valid {subject, body, day} to fill.
const WARM_STEP = SEQUENCES.cleaning.find(step => step.day === 4) || SEQUENCES.cleaning[1];
