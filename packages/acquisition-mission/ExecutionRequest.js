...
const EXECUTION_INTENTS = Object.freeze({
  ...
  DECIDE_ACQUISITION_APPROACH: 'DECIDE_ACQUISITION_APPROACH',
  RECONCILE_ACQUISITION_APPROACH: 'RECONCILE_ACQUISITION_APPROACH',
  ASSESS_PAID_ACQUISITION: 'ASSESS_PAID_ACQUISITION',
  GENERATE_VARIANTS: 'GENERATE_VARIANTS',
  GENERATE_CAPACITY: 'GENERATE_CAPACITY',
  REVISE_PREPARED_OUTREACH: 'REVISE_PREPARED_OUTREACH',
...
const ACTION_TO_INTENT = Object.freeze({
  ...
  mission_continuation: EXECUTION_INTENTS.MISSION_CONTINUATION,
  decide_acquisition_approach: EXECUTION_INTENTS.DECIDE_ACQUISITION_APPROACH,
  reconcile_acquisition_approach: EXECUTION_INTENTS.RECONCILE_ACQUISITION_APPROACH,
  assess_paid_acquisition: EXECUTION_INTENTS.ASSESS_PAID_ACQUISITION,
...
const INTENT_TO_ACTION = Object.freeze({
  ...
  [EXECUTION_INTENTS.MISSION_CONTINUATION]: 'mission_continuation',
  [EXECUTION_INTENTS.DECIDE_ACQUISITION_APPROACH]: 'decide_acquisition_approach',
  [EXECUTION_INTENTS.RECONCILE_ACQUISITION_APPROACH]: 'reconcile_acquisition_approach',
  [EXECUTION_INTENTS.ASSESS_PAID_ACQUISITION]: 'assess_paid_acquisition',
  [EXECUTION_INTENTS.GENERATE_VARIANTS]: 'generate_variants',
  [EXECUTION_INTENTS.GENERATE_CAPACITY]: 'generate_capacity',
  [EXECUTION_INTENTS.REVISE_PREPARED_OUTREACH]: 'revise_prepared_outreach',
...
const INTENT_SPECIALISTS = Object.freeze({
  ...
  [EXECUTION_INTENTS.MISSION_CONTINUATION]: 'max',
  [EXECUTION_INTENTS.DECIDE_ACQUISITION_APPROACH]: 'max',
  [EXECUTION_INTENTS.RECONCILE_ACQUISITION_APPROACH]: 'max',
  [EXECUTION_INTENTS.ASSESS_PAID_ACQUISITION]: 'penny',
  [EXECUTION_INTENTS.GENERATE_VARIANTS]: 'paige',
  [EXECUTION_INTENTS.GENERATE_CAPACITY]: 'emmett',
  [EXECUTION_INTENTS.REVISE_PREPARED_OUTREACH]: 'max',
