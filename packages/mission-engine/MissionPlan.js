...
const EXECUTION_ALIASES = Object.freeze({
  ...
  prospect_acquisition: BUILTIN_IDS.PROSPECT_ACQUISITION,
  'prospect acquisition': BUILTIN_IDS.PROSPECT_ACQUISITION,
  'acquire prospects': BUILTIN_IDS.PROSPECT_ACQUISITION,
  'import prospect list': BUILTIN_IDS.PROSPECT_ACQUISITION,
  company_enrichment: BUILTIN_IDS.COMPANY_ENRICHMENT,
  'company enrichment': BUILTIN_IDS.COMPANY_ENRICHMENT,
  'company intelligence': BUILTIN_IDS.BUSINESS_INTELLIGENCE,
  'analyze company': BUILTIN_IDS.BUSINESS_INTELLIGENCE,
  business_intelligence: BUILTIN_IDS.BUSINESS_INTELLIGENCE,
  'business intelligence': BUILTIN_IDS.BUSINESS_INTELLIGENCE,
