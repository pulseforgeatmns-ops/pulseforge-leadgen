...
const ACCOUNT_PRIORITIZATION_PATTERNS = [
  ...
  /\bwho should i focus on(?: today)?\b/i,
  /\bwhich prospect should i focus on\b/i,
  /\bwhat are my top accounts\b/i,
  /\bwho should i work first\b/i,
  /\bwho should i work on\b/i,
  /\bwho should i contact first\b/i,
  /\bwho should i call first\b/i,
  /\bwhat should i prioritize\b/i,
  /\bwhere should i go today\b/i,
  /\bwhere should i start\b/i,
  /\bwhich account should i start with\b/i,
