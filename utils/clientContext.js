...
async function ensureClientArchitecture() {
  ...
  await pool.query(`
    INSERT INTO clients (
      ...
      ARRAY['property_management','probate_estate','renovation_lender',
            'insurance_restoration','home_inspector','listing_agent'],
      'Property managers, probate and estate professionals, renovation lenders, insurance restoration partners, home inspectors, and listing agents in MSHI service areas',
