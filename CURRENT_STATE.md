...
- `POST /api/v1/clients/:id/interview/start` · `POST/GET /api/v1/interview/:id` · `POST /api/v1/interview/:id/resume` · `GET /api/v1/interview/:id/blueprint` · `POST /api/v1/blueprint/:id/revise|approve` · `POST /api/v1/interview/:id/growth/start|message` · `POST /api/v1/interview/:id/readiness/start|message` · `POST /api/v1/interview/:id/campaign/start|message` · `GET /api/v1/clients/:id/blueprint` · `GET /client-intel` → Client Intelligence (SPEC-083/084/085 Brief; Initial Growth Direction; SPEC-086 Growth Conversation Draft; SPEC-087 Readiness; SPEC-088 Growth Plan; SPEC-089 First Campaign Planning); CLI `npm run client:intel:interview`
