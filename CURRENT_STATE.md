...
| **Last Completed** | SPEC-035 Direct Mail Execution (v1 / ADR-022); SPEC-034 Campaign Review Workspace (v1 / ADR-021); SPEC-033 Mail Package Generator (v1); SPEC-031 Business Signals (ADR-018); SPEC-028 Client Playbook (ADR-015); SPEC-027B Proposal Generator; SPEC-026 Opportunity Ranking; SPEC-024 Prospect Discovery; SPEC-022/023 thin slice; SPEC-021–000 |
