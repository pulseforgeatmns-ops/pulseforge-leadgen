...
| **Next Spec** | [SPEC-030 Company Intelligence](docs/specs/SPEC-030_Company_Intelligence_Capability.md) (Proposed / ADR-017) → [SPEC-031 Business Signals](docs/specs/SPEC-031_Business_Signals_Capability.md) (Proposed / ADR-018) — before Execution; [SPEC-032 Mission Memory](docs/specs/SPEC-032_Mission_Memory.md) (Proposed / ADR-019); then [SPEC-029 Execution Engine](docs/specs/SPEC-029_Execution_Engine.md); Campaign Builder live adapter; [SPEC-015 Market Intelligence Domain](docs/specs/SPEC-015_Market_Intelligence_Domain.md) |
...
| **In Progress** | SPEC-014 dual-write operational readiness; SPEC-030 Company Intelligence (proposed; supersedes unfinished SPEC-025 enrichment); SPEC-031 Business Signals (proposed / ADR-018); SPEC-032 Mission Memory (proposed / ADR-019); Campaign Builder live adapters |
