...
- `POST /api/v1/clients/:id/interview/start` · `POST/GET /api/v1/interview/:id` · `GET /api/v1/interview/:id/blueprint` · `POST /api/v1/blueprint/:id/revise|approve` · `GET /api/v1/clients/:id/blueprint` · `GET /client-intel` → Client Intelligence Engine (SPEC-083); CLI `npm run client:intel:interview`
