...
| [ADR-010](docs/adr/ADR-010_Mission_Engine.md) | Mission Engine | Accepted | Operators express intent; Max orchestrates via Capability Registry; durable missions; review before outreach |
